...
class Student:
    def __init__(self,root):
        ...
        self.search_var=StringVar()
         ...
         #first image
        img=Image.open(r"C:\Users\Dark Demon\Desktop\Face Recognition system\img\student.jpg")
        ...
        #second image
        img1=Image.open(r"C:\Users\Dark Demon\Desktop\Face Recognition system\img\download.png")
        ...
        #thrid image
        img2=Image.open(r"C:\Users\Dark Demon\Desktop\Face Recognition system\img\smart-attendance.jpg")
        ...
        f_lbl.place(x=1000,y=0,width=550,height=130)
          ...
          #background image
        img3=Image.open(r"C:\Users\Dark Demon\Desktop\Face Recognition system\img\papers-face-recognition-1.jpg")
        ...
        img_left=Image.open(r"C:\Users\Dark Demon\Desktop\Face Recognition system\img\girl.jpeg")
        ...
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("times new romen",13,"bold"),state="readonly",width=20)
        ...
        # Roll no
        rol_no_label=Label(class_student_frame,text="Roll No:",font=("times new roman",13,"bold"),bg="white")
        rol_no_label.grid(row=1,column=2,padx=10,pady=5,sticky=W)

        rol_no_entry=ttk.Entry(class_student_frame,textvariable=self.var_roll,width=20,font=("times new roman",13,"bold"))
        rol_no_entry.grid(row=1,column=3,padx=10,pady=5,sticky=W)
        ...
        studentName_entry=ttk.Entry(class_student_frame,textvariable=self.var_email,width=20,font=("times new roman",13,"bold"))
        ...
        btn_frame.place(x=0,y=195,width=715,height=35)
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=715,font=("times new roman",13,"bold"),bg="green",fg="white")
        take_photo_btn.place(x=0,y=0,width=715,height=35)
        ...
        img_right=Image.open(r"C:\Users\Dark Demon\Desktop\Face Recognition system\img\student.jpg")
        ...
        search_label=Label(Search_frame,text="Search By:",font=("times new roman",15,"bold"),fg="black")
        search_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)

        serach_combo=ttk.Combobox(Search_frame,font=("times new roman",13,"bold"),state="readonly",width=17)
        serach_combo["values"]=("Select ","Roll","Phone")
        ...
        search_btn=Button(Search_frame,text="Search",width=18,command=self.search_data,font=("times new roman",12,"bold"),bg="green",fg="white")
  ...
  #--------function decration------
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
              ...
              try:
                  conn=mysql.connector.connect(host="localhost",username="root",password="ujjwal",database="face_recognizer")
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Delete","Successgully deleterd student details ",parent=self.root)
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                messagebox.showinfo("Result","Generating data sets completed successfuly!!")
            except Exception as es:
                messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)
